 ...
 */
export declare function WriteFile(targetPath: string, content: object): Promise<void>;
/**
 * 依照JSON的格式寫入檔案，並自動檢查是否有相應的資料夾位置
 * @param targetPath 指定位置
 * @param content 內容
 */
export declare function WriteFileAsJSON(targetPath: string, content: object): Promise<void>;
/** 讀取檔案
